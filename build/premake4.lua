...
solution "orx-mrt-demo"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"orx-mrt-demo.wasm\"'",
        ...
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/orx-mrt-demo.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && orx-mrt-demo -b ../build/orx-mrt-demo.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\orx-mrt-demo.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./orx-mrt-demo -b ../build/orx-mrt-demo.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/orx-mrt-demo.obr"}
